...
import 'package:etjob_clone_app/ForgetPassword/forget_password_screen.dart';
import 'package:etjob_clone_app/Services/global_methods.dart';
import 'package:etjob_clone_app/Services/global_variables.dart';
import 'package:etjob_clone_app/SignupPage/signup_screen.dart';
                      ...
                      TextFormField(
                        ...
                        validator: (value){
                          if(value!.isEmpty|| !value.contains('@')){
                            return 'please insert the valid email address';
                          }
                          else{
                            return null;
                          }
                      ...
                      TextFormField(
                        ...
                        validator: (value){
                          if(value!.isEmpty||value.length<7){
                            return 'please insert the valid password';
                          }
                          else{
                            return null;
                          }
