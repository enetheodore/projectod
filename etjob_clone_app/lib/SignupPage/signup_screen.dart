  ...
  void _submitFormOnSignUp() async{
    ...
    if(isValid){
      ...
      try{
        ...
        final _uid=user!.uid;
        final ref=FirebaseStorage.instance.ref().child('user images').child(_uid + '.jpg');
                        ...
                        TextFormField(
                          ...
                          validator: (value){
                            if(value!.isEmpty|| !value.contains('@')){
                              return 'Insert The Valid Email Address';
                            }
                            else{
                              return null;
                            }
                        ...
                        TextFormField(
                          ...
                          validator: (value){
                            if(value!.isEmpty|| value.length < 7){
                              return 'Insert The Valid Password';
                            }
                            else{
                              return null;
                            }
